 ...
 * @author muril
 */
@WebServlet(name = "JuroSimples2", urlPatterns = {"/JuroSimples2"})
...
"" 
                    ...
                    + "<select style='margin-left:5px' class='form-control' name='base_tempo'> <option value='Dias'> Dias</option>"
